...
public class RecipesController : ControllerBase
{
  ...
  // [FromQuery] Recipe recipeQuery
  [HttpGet]
  public ActionResult<List<Recipe>> GetRecipes([FromQuery] Recipe recipeQuery)
  {
    try
    {
      List<Recipe> recipes = _recipesService.GetRecipes(recipeQuery.Title);
      return Ok(recipes);
    }
    catch (Exception e)
    {
