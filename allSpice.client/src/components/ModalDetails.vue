  ...
  <div class="modal fade" id="ModalDetails" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered ">
      <div class="modal-content container-fluid">
        <section class="modal-header row p-0">

        </section>
        <section class="modal-body row p-0">
          ...
          <div class="col-8 d-flex flex-column justify-content-between">
            <section class="row">
              <div class="col-12 fs-3 py-2 px-4 d-flex justify-content-between">
                <div v-if="edit == 'edit'">
                  <input v-model="editable.title" class="form-control" type="text">
                </div>
                <div v-else>
                  {{ recipe.title }}
                </div>
                <div v-if="recipe.creator?.id == AppState.account?.id">
                  <i v-if="edit == ''" @click="edit = 'edit'" class="mdi mdi-pencil add-button"></i>
                  <div v-if="edit == 'edit'">
                    <i @click="editRecipe()" class="mdi mdi-plus add-button me-2"></i>
                    <i @click="edit = ''" class="mdi mdi-close add-button"></i>
                  </div>
                </div>
              </div>
              ...
              <div class="col-5 mx-auto elevation-3 p-0">
                ...
                <div v-if="edit == 'edit'" class="px-3">
                  <textarea v-model="editable.instructions" class="form-control" style="resize: none;" name="title"
                    id="insturction" cols="30" rows="10"></textarea>
                </div>
